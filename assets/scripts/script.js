const newTwtt = (atUsername, username, user_id, date, content, twtt_id) => {
    ...
    userActions.innerHTML = `<i id="rt" class="fas fa-retweet rt" value="${twtt_id}"></i>&nbsp;<i id="star" class="fas fa-star star" value="${twtt_id}"></i>`;
...
const newRtwtt = (atUsername, username, user_id, date, content, user_rt_id, atUsernameAuthor_rt, usernameAuthor_rt, twtt_id) => {
    let twtt = document.createElement('div');
    let header = document.createElement('div');
    let twContent = document.createElement('div');
    let userActions = document.createElement('div');
